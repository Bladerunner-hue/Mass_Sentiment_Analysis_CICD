...
class TestAnalysisAPI:
    ...
    def test_analyze_missing_text(self, client, api_headers):
        ...
        response = client.post("/api/v1/analysis/analyze", json={}, headers=api_headers)

        assert response.status_code == 400

    def test_analyze_empty_text(self, client, api_headers):
        """Test analyze endpoint with empty text."""
        response = client.post("/api/v1/analysis/analyze", json={"text": ""}, headers=api_headers)
    ...
    def test_analyze_text_too_long(self, client, api_headers):
        ...
        response = client.post(
            "/api/v1/analysis/analyze", json={"text": long_text}, headers=api_headers
        )
    ...
    def test_quick_analyze_faster_than_full(self, client, api_headers):
        ...
        quick_response = client.post(
            "/api/v1/analysis/analyze/quick", json={"text": text}, headers=api_headers
        )

        # Full analysis
        full_response = client.post(
            "/api/v1/analysis/analyze", json={"text": text}, headers=api_headers
        )
    ...
    def test_batch_analyze_limit(self, client, api_headers):
        ...
        response = client.post("/api/v1/analysis/batch", json={"texts": texts}, headers=api_headers)

        assert response.status_code == 400

    def test_batch_analyze_empty_list(self, client, api_headers):
        """Test batch analyze with empty list."""
        response = client.post("/api/v1/analysis/batch", json={"texts": []}, headers=api_headers)
...
class TestStatsAPI:
    ...
    def test_get_history(self, client, api_headers):
        ...
        response = client.get("/api/v1/stats/history", headers=api_headers)
    ...
    def test_get_history_pagination(self, client, api_headers):
        ...
        response = client.get("/api/v1/stats/history?page=1&per_page=10", headers=api_headers)
