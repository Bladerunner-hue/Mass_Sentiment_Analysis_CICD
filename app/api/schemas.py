...
class SentimentResultSchema(Schema):
    ...
    compound_score = fields.Float(metadata={"description": "VADER compound score (-1 to 1)"})
    scores = fields.Nested(SentimentScoresSchema, metadata={"description": "Detailed VADER scores"})
    primary_emotion = fields.String(
        allow_none=True, metadata={"description": "Primary detected emotion"}
    )
    ...
    confidence = fields.Float(
        allow_none=True, metadata={"description": "Confidence in primary emotion (0-1)"}
    )
    processing_time_ms = fields.Integer(metadata={"description": "Processing time in milliseconds"})
...
class BatchResponseSchema(Schema):
    ...
    processing_time_ms = fields.Integer(metadata={"description": "Total processing time"})
...
class TokenResponseSchema(Schema):
    ...
    token_type = fields.String(dump_default="Bearer", metadata={"description": "Token type"})
...
class StatsResponseSchema(Schema):
    ...
    average_confidence = fields.Float(metadata={"description": "Average confidence score"})
    average_processing_time_ms = fields.Float(metadata={"description": "Average processing time"})
...
class ErrorSchema(Schema):
    ...
    details = fields.Dict(allow_none=True, metadata={"description": "Additional error details"})
...
class PaginatedHistorySchema(Schema):
    ...
    items = fields.List(
        fields.Nested(AnalysisHistorySchema), metadata={"description": "List of analyses"}
    )
