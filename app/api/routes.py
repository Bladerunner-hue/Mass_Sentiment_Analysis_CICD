...
analysis_ns = Namespace(
    'analysis',
    description='Sentiment and emotion analysis operations'
)

# Request/Response models for Swagger
text_input_model = analysis_ns.model('TextInput', {
    'text': fields.String(
        required=True,
...
sentiment_scores_model = analysis_ns.model('SentimentScores', {
...
batch_input_model = analysis_ns.model('BatchInput', {
    'texts': fields.List(
        fields.String,
        required=True,
...
batch_result_model = analysis_ns.model('BatchResult', {
...
batch_ns = Namespace(
    'batch',
    description='Batch processing job management'
)

batch_job_model = batch_ns.model('BatchJob', {
...
history_item_model = stats_ns.model('HistoryItem', {
