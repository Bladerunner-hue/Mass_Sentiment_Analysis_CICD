...
from pyspark.sql.functions import (
    col, from_json, udf, window, count, avg,
    current_timestamp, to_timestamp, expr
)
from pyspark.sql.types import (
    StructType, StructField, StringType, 
    FloatType, MapType, TimestampType
)
import pandas as pd
...
class TwitterSparkStreaming:
    ...
    def analyze_stream(self, df: DataFrame) -> DataFrame:
        ...
        # Apply analysis
        analyzed_df = df.withColumn(
            "analysis",
            analyze_udf(col("text"))
        )
    ...
    def start_pipeline(self):
        ...
        console_query = analyzed_df \
            .select("tweet_id", "text", "sentiment", "primary_emotion") \
            .writeStream \
            .outputMode("append") \
            .format("console") \
